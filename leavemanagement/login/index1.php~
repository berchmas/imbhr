...
<div align="right"> <FORM METHOD=POST ACTION="../login/login.php">Username:<INPUT TYPE="text" SIZE="17" NAME="userrole" STYLE="width:5em;">Password:<INPUT TYPE="password" SIZE="17" NAME="userpsw" STYLE="width:5em;"><INPUT TYPE="submit" NAME="sublogin" value="Login" STYLE="width:4em;"></FORM></div>
